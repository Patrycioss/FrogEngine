...
namespace fe
{
  ...
  void Box2DDebug::DrawSolidPolygonCallback(b2Transform _transform,
	...
	float windowWidth = fe::Engine::CurrentSettings.windowWidth;
	float windowHeight = fe::Engine::CurrentSettings.windowHeight;
  ...
  void Box2DDebug::Initialize() {
	...
	debugDraw.drawingBounds = {{0, 0},
		{(float)fe::Engine::CurrentSettings.windowWidth, (float)fe::Engine::CurrentSettings.windowHeight}};
